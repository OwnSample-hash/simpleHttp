...
/**
 * @def psnip_trap()
 * @brief Trigger a debug trap
 *
 * This macro is used to trigger a debug trap, which can be useful for debugging
 * purposes. It will cause the program to stop execution at the point where it
 * is called, allowing you to inspect the state of the program.
 *
 * The implementation of this macro may vary depending on the compiler and
 * platform.
 */
